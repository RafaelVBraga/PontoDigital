...
public class CadastroPanel extends JPanel implements ActionListener{
    ...
    private JLabel imagemLabel, nomeLabel, matriculaLabel,orgaoLabel,setorLabel, digitalCapturadaLabel;
    ...
    public CadastroPanel(PontoDigitalService servico) {
        ...
        nomeLabel.setBounds(10,30,50,30);
        formPanel.add(nomeField);
        nomeField.setBounds(75,30,220,30);
        formPanel.add(matriculaLabel);
        matriculaLabel.setBounds(10,70,70,30);
        formPanel.add(matriculaField);
        matriculaField.setBounds(75,70,220,30);
